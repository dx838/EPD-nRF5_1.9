...
static const Festival festivals[] = {
    {1, 1, "元旦节"},  {2, 14, "情人节"}, {1, 23, "大庆节"},  {3, 4, "大庆节"},  {3, 8, "妇女节"},  {3, 12, "植树节"},  {4, 1, "愚人节"},
...
static const Festival festivals_lunar[] = {
    {1, 1, "春节"},   {1, 15, "元宵节"},   {2, 2, "龙抬头"},  {2, 10, "正庆节"}, {5, 3, "正庆节"},  {5, 5, "端午节"}, {6, 26, "正庆节"}, {7, 7, "七夕节"}, {7, 15, "中元节"},
    {8, 15, "中秋节"}, {9, 9, "重阳节"},  {10, 1, "寒衣节"}, {12, 6, "正庆节"},  {12, 8, "腊八节"},  {12, 17, "正庆节"},  {12, 30, "除夕"},
};
