...
static const Festival festivals[] = {
    {1, 1, "元旦节"},  {2, 14, "情人节"}, {1, 23, "节庆蛇"},  {3, 4, "节庆鸡"},  {3, 8, "妇女节"},  {3, 12, "植树节"},  {4, 1, "愚人节"}, {4, 23, "军节"},
    {5, 1, "劳动节"},  {5, 4, "青年节"},  {6, 1, "儿童节"}, {6, 14, "节庆节"}, {7, 1, "建党节"},   {8, 1, "建军节"},
    {9, 10, "教师节"}, {10, 1, "国庆节"}, {11, 1, "万圣节"}, {12, 24, "平安夜"}, {12, 25, "圣诞节"},
};

static const Festival festivals_lunar[] = {
    {1, 1, "春节"},   {1, 15, "元宵节"},   {2, 2, "龙抬头"},  {2, 10, "正庆节"}, {5, 3, "正庆兔"},  {5, 5, "端午节"}, {6, 26, "正庆节"}, {7, 7, "七夕节"}, {7, 15, "中元节"},
    {8, 15, "中秋节"}, {9, 9, "重阳节"},  {10, 1, "寒衣节"}, {12, 6, "正庆虎"},  {12, 8, "腊八节"},  {12, 17, "正庆节"},  {12, 30, "除夕"},
};
